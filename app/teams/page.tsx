...
export default function TeamsPage() {
  ...
  // Demo leave team function (POC only - not for production)
  const handleDemoLeaveTeam = useCallback(() => {
    setUserTeam(null);
            ...
            <div className="space-y-6">
              {userTeam ? (
                <>
                  ...
                  {/* Demo Leave Team Button - POC Only */}
                  <div className="rounded-2xl border border-dashed border-yellow-500/30 bg-yellow-500/5 p-4">
                    <div className="flex items-start gap-3">
                      <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-yellow-500/20 text-yellow-500">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="mt-1 text-xs text-white/50">
                          This button is for proof-of-concept testing. In production, team assignments are permanent.
                        </p>
                        <button
                          onClick={handleDemoLeaveTeam}
                          className="mt-3 rounded-lg border border-yellow-500/30 bg-yellow-500/10 px-4 py-2 text-sm font-medium text-yellow-500 transition-colors hover:bg-yellow-500/20"
                        >
                          Demo: Leave Team
                        </button>
                      </div>
