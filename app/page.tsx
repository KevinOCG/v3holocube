      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-6 md:px-10">
        <header className="flex items-center justify-between gap-4">
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <Link
              href="/teams"
              className="flex items-center gap-2 rounded-full border border-[#d12429]/30 bg-[#d12429]/10 px-4 py-2 text-sm font-medium text-[#d12429] transition-colors hover:bg-[#d12429]/20"
            >
              <svg
                className="h-4 w-4"
                fill="none"
